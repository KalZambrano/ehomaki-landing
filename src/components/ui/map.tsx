  ...
  return (
    <div className="bg-background/50 absolute inset-0 z-10 flex items-center justify-center backdrop-blur-xs">
      <div className="flex gap-1">
        ...
        <span className="bg-muted-foreground/60 size-1.5 animate-pulse rounded-full animate-delay-150" />
        <span className="bg-muted-foreground/60 size-1.5 animate-pulse rounded-full animate-delay-300" />
      </div>
    </div>
  );
}
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="border-gray-600 bg-gray-800 [&>button:not(:last-child)]:border-gray-600 flex flex-col overflow-hidden rounded-md border shadow-sm [&>button:not(:last-child)]:border-b">
      {children}
    </div>
  );
}
...
function ControlButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex size-8 items-center justify-center transition-all cursor-pointer",
        "first:rounded-t-md last:rounded-b-md",
        "hover:bg-gray-700 disabled:hover:bg-gray-700",
        "focus-visible:ring-gray-400 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset",
        "disabled:pointer-events-none disabled:opacity-50",
        "text-gray-200 disabled:text-gray-400",
      )}
      disabled={disabled}
    >
      {children}
